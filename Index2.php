...
<!--         Further plan for page:
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12 main">
                <div id="cupBase"><img class="position-absolute " src="/images/basevanilla.png"></div>
                <div id="cupTop"></div>
                <div id="cupFrost"></div>
            </div>
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <div class="row quantity">
                            <div class="quantity">
                                <p>Quantity: </p><input type="number" value="1" id="kiekis" name="quantity" min="1" max="100" data-width="100%">
                            </div>
                        </div>
                        <div class="row">
                            <input value="<?php echo $shipping?>" id="shipping" type="checkbox" checked data-toggle="toggle" data-on="SHIPPING" data-width="100%" data-off="PICK UP" onchange="GetPrice()">
                        </div>
                        <div class="row makeorder" >
                            <p>Your price, eur: </p>
                            <div id="price"></div>
                        </div>
                        <div class="row placeorder text-center">
                            <a class="button " onclick="SubmitOrder();">ORDER</a>
                        </div>
                    </div>
                </div>
            </div>           
    ...
    <div class="btn btn-primary btn-xl rounded-pill mt-5">
